...
<div class="index_page">
    <div class="post_body">
        ...
        if (!empty($_GET['other'])) {
            $sql = "SELECT * FROM tbl_bus_post WHERE days LIKE '%$other%'OR nights LIKE '%$other%' OR per_price LIKE '%$other%'";
        } else {
            $sql = "SELECT * FROM tbl_bus_post WHERE source LIKE '%$source%' AND destination LIKE '%$destination%'";
        }
